...
{
    ec_core_uart0_printf("key_press_event\r\n");
}
void key_long_press_event(void)
{
    ec_core_uart0_printf("key_long_press_event\r\n");
}
void key_up_event(void)
{
    ec_core_uart0_printf("key_up_event\r\n");
}
...
int main(void)
{
    ...
    ec_core_uart0_printf("ec_app_key_test\r\n"); //串口0 printf打印

    //占用一个gpio和一个软件定时器
    //按键长按时间为2秒
    ec_core_key_init(EC_CORE_GPIO_P1, EC_CORE_SW_TIMER5, 20, key_press_event, key_long_press_event, key_up_event);
